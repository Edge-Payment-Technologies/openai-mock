defmodule AiProvidersWeb.Router do
  use AiProvidersWeb, :router

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {AiProvidersWeb.Layouts, :root}
  ...
  if Application.compile_env(:ai_providers, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: AiProvidersWeb.Telemetry
